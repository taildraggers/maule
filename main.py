"""Scrape Maule listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Maule Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    ("Trade-A-Plane", "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=maule&s-original-search=maule"),
    ("Controller", "https://www.controller.com/listings?keywords=maule"),
    ("ASO", "https://aso.com/search?q=Maule"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Maule Listings</h2>
    <p>View additional Maule Aircraft listings at these fine sites:</p>
